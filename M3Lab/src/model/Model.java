...
public class Model {
    ...
    /**
     * a list of all the possible class standings
     */
    private final ObservableList<ClassStanding> standings = FXCollections.observableArrayList();
    ...
    /**
     * @return a list of all the standings.  mostly used by UI to display in the table view
     */
    public ObservableList<ClassStanding> getStandings() {
        return standings;
    }
